...
//Lo mismo que en Star1, pero sin la restricción de no poder pasar por un punto más de una vez
    ...
    for (fila in 0 until mapa.size) {
        for (columna in 0 until mapa[0].size) {
            if (mapa[fila][columna] == '0') {
                sumaScores += puntosMapa2 (fila, columna, mapa)
            }
        }
    }
...
fun puntosMapa2(fila: Int, columna: Int, mapa: MutableList<MutableList<Char>>) : Int {
